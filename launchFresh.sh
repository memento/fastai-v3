...
#
#Note : Remember a you build an image (named neural_marvel) and from that image, 
# you can run multiple containers (here, just one named neural_marvel_instance_1)
#
#Stop container
